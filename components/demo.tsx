...
import { MonitorPlay, PenTool, LayoutTemplate } from "lucide-react";

export default function DemoOne() {
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-center overflow-hidden bg-black text-white">
      <GLSLHills />
      <div className="space-y-6 pointer-events-none z-10 text-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full px-4">
